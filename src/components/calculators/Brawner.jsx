...
import { calcularBrawner } from '../../utils/formulas'
import { validarBrawner } from '../../utils/validacao'
...
export default function Brawner() {
  ...
  function handleCalcular() {
    const novosErros = validarBrawner(campos)
    setErros(novosErros)
    if (Object.keys(novosErros).length > 0) return
    setResultado(calcularBrawner(campos))
  }
